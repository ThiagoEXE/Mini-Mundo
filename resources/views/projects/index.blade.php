<x-app-layout>
            ...
            <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form id="project-form" action="{{ route('projects.store') }}" method="POST" class="flex flex-wrap md:flex-nowrap items-center gap-3">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <input type="text" name="name" id="input-name" placeholder="Nome do Projeto" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white text-sm  @error('end_date') border-red-500 @enderror" required>
                        @error('name')
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="p-4 text-center text-gray-500">Nenhum projeto encontrado.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <script>
        ...
        function editProject(project) {
            ...
            budgetInput.value = (project.budget).toLocaleString('pt-BR', {
